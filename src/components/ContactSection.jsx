...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="section-wrapper flex flex-col lg:flex-row lg:justify-between gap-12"
    >
      <div className="w-full lg:w-1/2 text-center md:text-left">
        ...
        <p className="text-base sm:text-lg md:text-xl leading-relaxed  mb-2">
          Say hello at{" "}
          <a
            href="mailto:lawrencelee1999@hotmail.co.uk"
            className="underline decoration-[var(--color-accent)] underline-offset-4"
          >
            lawrencelee1999@hotmail.co.uk
          </a>
        </p>
      ...
      <div className="w-full lg:w-1/2">
        <form className="space-y-6" onSubmit={handleSubmit}>
          <label
            htmlFor="name"
            className="block mb-2 text-[var(--color-muted)]"
          >
            Name
          </label>
          <input
            ...
            className="w-full px-4 py-3 bg-[#1A1A1A] text-white rounded-sm focus:outline-none"
          />
          <label
            htmlFor="email"
            className="block mb-2 text-[var(--color-muted)]"
